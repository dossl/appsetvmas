...
@Component({
  selector: 'app-buypoint',
  templateUrl: './buypoint.page.html',
  styleUrls: ['./buypoint.page.scss'],
})
export class BuypointPage implements OnInit {
  ...
  constructor(public navCtrl: NavController,private insomnia: Insomnia,public network: Network,private modal: PopoverController,private service: AnuncioService,public toastCtrl: ToastController, private networkService: NetworkService,public platform: Platform, public splashscreen: SplashScreen) { 
  ...
  ngOnInit() {
    ...
    if(this.isConnected){
        ...
        this.num_Movil()
        this.num_tarjeta()
        this.monto = JSON.parse(localStorage.getItem("comprar"))
