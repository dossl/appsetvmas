...
export class ContactPage implements OnInit {
  ...
  constructor(public navCtrl: NavController,public render: Renderer,private alertCtrl: AlertController,private insomnia: Insomnia,public network: Network,private toast: Toast,private servCo: SettingsService, private servAnuncio: AnuncioService, private networkService: NetworkService,private sqlite: SQLite,private sanitizer: DomSanitizer,public platform: Platform, public splashscreen: SplashScreen) { 
